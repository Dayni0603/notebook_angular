export class renewalRequestModel {
  ...
  //       {
  //         name: 'branchId',
  //         validationRule: [Validators.required, Validators.minLength(1), Validators.maxLength(4)]
  //       }
  //     ]
  //   };
  // }
...
export class newBorrowerRenewalRequestModel {
  ...
  //     fields.push({
  //       name: prop,
  //       dataType: prop == 'branchId' ? 'string' : 'number',
  //       label: prop.replace(/([A-Z])/g, ' $1').replace(/^./, function (str) {
  //         return str.toUpperCase();
  //       }),
  //       controlType: 'input',
...
export class newBorrowerRequestModel {
  constructor(
    public branchId: number = 0,
    public payment?: number,
    public term?: number,
...
export class formerBorrowerRequestModel {
  constructor(public branchId: number = 0) {}
